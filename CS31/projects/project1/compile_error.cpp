...
int main()
{
    ...
    cout.precision(2);
    cout << endl;
    // COMPILE ERROR #1: Missing semicolon at end of statement
    ...
    {
        // COMPILE ERROR #2: Undefined identifier - used a variable that was never declared
        cout << "It was " << undefined_variable << " more often than it rained.";
        cout << endl;
    }
